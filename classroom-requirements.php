        ...
        <div class="main_contents">
            <div class="row mt-5 ps-5">
                <div class="d-flex flex-column align-items-center justify-content-center">
                    <h4 class="text-danger hFont fw-bolder lh-lg pt-5 pb-3 text-uppercase">CLASS ROOM REQUIREMENTS OF <?php echo $semester2 . " " . $year ?></h4>
            ...
            <div class="row mt-5 ps-5">
                <div class="d-flex flex-column align-items-center justify-content-center">
                    <h4 class="text-danger hFont fw-bolder lh-lg pt-5 pb-3">CLASS ROOM REQUIREMENTS GRAPH & CHARTS</h4>
                    <div class="w-50">
