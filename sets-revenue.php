        ...
        <div class="main_contents">
            ...
            <div class="row mt-5 ps-5">
                <div class="d-flex flex-column align-items-center justify-content-center">
                    <h4 class="text-danger hFont fw-bolder lh-lg pt-5 pb-3 text-uppercase">SETS Department revenue comparison</h4>
            ...
            <div class="row mt-5 ps-5">
                <div class="d-flex flex-column align-items-center justify-content-center">
                    <h4 class="text-danger hFont fw-bolder lh-lg pt-5 pb-3 text-uppercase">SETS Department revenue comparison GRAPH & CHARTS</h4>
                    <div class="w-75">
